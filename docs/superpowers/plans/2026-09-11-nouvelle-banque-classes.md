...
const QUIZ = [
  ...
  {s:"Ce problème est [[vraiment]] difficile.", c:"adverbe", w:"Formé sur l'adjectif vraie, il modifie l'adjectif difficile."},
  ...
  {s:"Elle ne mange [[ni]] viande ni poisson.", c:"conjonction", w:"Conjonction de coordination, toujours appuyée sur ne."},
...
const CAM = [
  ...
  {w:"or", a:{s:"Il devait pleuvoir, [[or]] le ciel resta bleu.", c:"conjonction"}, b:{s:"Une bague en [[or]] blanc.", c:"nom"},
